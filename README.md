...
Ferramenta de apoio à *Ficha de Avaliação Rápida de Risco em Saúde Pública*, com:
...
- **Linha do tempo** do evento, com exportação em imagem (PNG) e dados (CSV).

Elaborado por **Fernanda Haltenburg - Residente de Vigilância em Saúde - Universidade de Brasília FS/UnB**.
